...
const TechLogos = [
  {
    ...
    element: (
      <svg
        ...
        className="text-link dark:text-link-dark mb-3 me-0 mt-4 flex w-12 origin-center self-center text-sm transition-all ease-in-out lg:w-10"
      >
  ...
  {
    id: 4,
    element: <Image src={nestJSLogo} width={40} height={40} alt="nest logo" />,
  },
  {
    id: 5,
    element: (
      <Image src={springLogo} width={80} height={40} alt="spring logo" />
    ),
  },
  {
    id: 6,
    element: (
      <p className="select-none text-lg font-semibold tracking-wide text-white">
        SQL
      </p>
    ),
  },
  {
    id: 7,
    element: <Image src={mongoLogo} width={100} height={50} alt="mongo logo" />,
  },
];
